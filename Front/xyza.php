...
<!-- <-- <section class="background firstsection">
    <div class="box-main">
        <div class="firstHalf">
           <p class="text-big">If You Want To Know about All The Teacher Info <br>Click here </p>
           <button class="btn">Click Here For Teacher Info</button><br>


            <div>
           <br><p class="text-small">Click Here for full chart</p>
           <button class="btn">View Full Chart</button>
        ...
        <div class="secondHalf">
         <img src="img/pic3.jpg" alt="class Image">
         </div>
    </div>
